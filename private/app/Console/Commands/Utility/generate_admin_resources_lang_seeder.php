...
class generate_admin_resources_lang_seeder extends Command
{
...
';
     ...
     * @var string
     */
    protected $signature = 'generate:adminresourceslangseeder';
    ...
    public function handle(){
        ...
        $languages = ResourceLang::where("type","admin")->orderBy('section')->orderBy('label')->get();
        ...
        file_put_contents($seeder_dir."ResourcesAdminLangTableSeeder.php",$content);
        return 0;
    }
}
