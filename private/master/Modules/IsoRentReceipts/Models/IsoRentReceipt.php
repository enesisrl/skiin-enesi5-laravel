...
namespace Master\Modules\IsoRentReceipts\Models;
...
class IsoRentReceipt extends Model implements HasMedia {

    use InteractsWithMedia;

    protected $table = 'iso_rent_receipts';
