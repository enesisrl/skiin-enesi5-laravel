<!DOCTYPE html><html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
        ...
        <title>Magneti Marelli Elaborazioni 1919</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
        ...
        <div style="width: 100%; background-color: #f1f1f1; text-align: center;">
            <div style="max-width: 600px; margin: 0 auto;" class="email-container">
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                    <tbody><tr>
                        <td valign="middle" class="hero bg_black" style="height: 100px;">
                            @include('BaseModulePreset::mail.partials.header')
                        </td>
                    </tr>

                    <tr>
                        <td class="bg_black email-section" style="text-align:center; padding-bottom: 5em;">
                            @yield('content')
                            <div style="padding: 30px 0 15px 0; color: #FFFFFF; text-align: center; font-size: 20px; line-height: 1.4; font-weight: 400; text-transform: uppercase; letter-spacing: 1px;">
                                {!! __('front::mail.our_tuning_your_style') !!}
                            </div>
                        </td>
                    </tr>
                    </tbody>
